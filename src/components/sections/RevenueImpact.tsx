...
const impacts = [
  {
    icon: DollarSign,
    title: "Raise BAMS Seat Value",
    desc: "Sharper counselling and stronger brand trust help BAMS colleges justify premium perception without weakening enquiry quality.",
    note: "Premium admissions",
  },
  {
    icon: Users,
    title: "Reduce Vacant BAMS Seats",
    desc: "A healthier NEET counselling funnel fills the pipeline earlier, cutting seat leakage and last-minute dependence during admission season.",
    note: "Better seat fill",
  },
  {
    icon: BarChart3,
    title: "Stabilise Admission Cashflow",
    desc: "Predictable counselling-to-confirmation movement creates steadier fee collections, better intake planning, and stronger revenue timing.",
